...
pub trait ConnectionToPlugin: Send + Unpin {
...
///
/// Function intended to be part of the Plugin API.
fn store_opaque_from_plugin(mut env: FunctionEnvMut<Env>, tag: u64, val: u32) {
...
///
/// Function intended to be part of the Plugin API.
fn get_opaque_from_plugin(mut env: FunctionEnvMut<Env>, tag: u64) -> u64 {
    let env_data = env.data_mut();
...
/// implementation.
fn remove_opaque_from_plugin(mut env: FunctionEnvMut<Env>, tag: u64) -> u64 {
    let env_data = env.data_mut();
...
///
/// Function intended to be part of the Plugin API.
pub fn print_from_plugin(env: FunctionEnvMut<Env>, ptr: WasmPtr<u8>, len: WASMLen) {
    let instance = if let Some(i) = env.data().get_instance() {
        i
    } else {
        return;
...
///
/// Function intended to be part of the Plugin API.
pub fn get_connection_from_plugin(
    mut env: FunctionEnvMut<Env>,
...
///
/// Function intended to be part of the Plugin API.
pub fn set_connection_from_plugin(
    mut env: FunctionEnvMut<Env>,
    field_ptr: WasmPtr<u8>,
    field_len: WASMLen,
    val_ptr: WasmPtr<u8>,
